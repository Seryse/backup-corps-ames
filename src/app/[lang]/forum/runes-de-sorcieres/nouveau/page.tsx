...
export default function NewRuneThreadPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
        await addDoc(collection(firestore, 'forum_threads'), {
            title: title.trim(),
            category: 'runes-de-sorcieres', // Catégorie forcée
            authorId: user.uid,
        ...
        router.push(`/${lang}/forum/runes-de-sorcieres`);
         ...
         <div className="max-w-2xl mx-auto">
          ...
          <Card className="bg-white border-none shadow-lg overflow-hidden">
            <CardHeader className="bg-amber-50/50 border-b border-amber-100/50 pb-8 pt-8">
              <CardTitle className="text-2xl font-light text-gray-800 text-center">Ouvrir une discussion</CardTitle>
              <CardDescription className="text-center text-gray-500">Partagez vos tirages, vos questions et vos découvertes sur les runes.</CardDescription>
            </CardHeader>
            <CardContent className="pt-8">
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="space-y-2">
                        ...
                        <Input 
                            placeholder="Ex: Question sur la rune Algiz..."
                    ...
                    <div className="space-y-2">
                        ...
                        <Textarea 
                            placeholder="Écrivez ici votre question ou votre partage..."
